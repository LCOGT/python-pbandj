...
PB_TYPE_DOUBLE   = _make_type('PB_TYPE_DOUBLE'  ,'double'  , 1)
PB_TYPE_FLOAT    = _make_type('PB_TYPE_FLOAT'   ,'float'   , 2)
PB_TYPE_INT64    = _make_type('PB_TYPE_INT64'   ,'int64'   , 3)
PB_TYPE_UINT64   = _make_type('PB_TYPE_UINT64'  ,'uint64'  , 4)
PB_TYPE_INT32    = _make_type('PB_TYPE_INT32'   ,'int32'   , 5)
PB_TYPE_FIXED64  = _make_type('PB_TYPE_FIXED64' ,'fixed64' , 6)
PB_TYPE_FIXED32  = _make_type('PB_TYPE_FIXED32' ,'fixed32' , 7)
PB_TYPE_BOOL     = _make_type('PB_TYPE_BOOL'    ,'bool'    , 8)
PB_TYPE_STRING   = _make_type('PB_TYPE_STRING'  ,'string'  , 9)
PB_TYPE_GROUP    = _make_type('PB_TYPE_GROUP'   ,'group'   ,10)
PB_TYPE_MESSAGE  = _make_type('PB_TYPE_MESSAGE' ,'message' ,11)
PB_TYPE_BYTES    = _make_type('PB_TYPE_BYTES'   ,'bytes'   ,12)
PB_TYPE_UINT32   = _make_type('PB_TYPE_UINT32'  ,'uint32'  ,13)
PB_TYPE_ENUM     = _make_type('PB_TYPE_ENUM'    ,'enum'    ,14)
PB_TYPE_SFIXED32 = _make_type('PB_TYPE_SFIXED32','sfixed32',15)
PB_TYPE_SFIXED64 = _make_type('PB_TYPE_SFIXED64','sfixed64',16)
PB_TYPE_SINT32   = _make_type('PB_TYPE_SINT32'  ,'sint32'  ,17)
